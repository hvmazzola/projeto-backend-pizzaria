...
const { validaTamanho } = require("../middleware/validacao.middleware");
...
// rotas put
router.put("/update/:id", authMiddleware, validaTamanho, tamanhoController.updateTamanhoController);
